"""
Adorad - Modern Computer Vision on the Fly
=====

A lightweight Computer Vision library in Python with powerful image and video processing operations.
Adorad is a set of utility functions designed to help speed up your Computer Vision workflow. Functions inside `adorad` will help reduce the number of calculation calls your code makes, ultimately making it neat, concise and readable.
...
def is_right_py_version(min_py_version):
    if sys.version_info < (3,):
        sys.stderr.write('Python 2 has reached end-of-life and is no longer supported by Adorad.')
        return False
...
EXTENSIONS = {
    'adorad.filters.cconvex': ['adorad/filters/cconvex.cpp'],
    'adorad.filters.cconvolve': ['adorad/filters/cconvolve.cpp', 'adorad/src/cfilters.cpp'],
    'adorad.distance.cdistance': ['adorad/distance/cdistance.cpp'],
    'adorad.morph.cmorph': ['adorad/morph/cmorph.cpp', 'adorad/src/cfilters.cpp'],
    'adorad.ndi.cndi' : ['adorad/ndi/include/cndimage.c', 
                       'adorad/ndi/include/cndfilters.c',
                       'adorad/ndi/include/cndfourier.c',
                       'adorad/ndi/include/cndinterpolation.c',
                       'adorad/ndi/include/cndmeasure.c',
                       'adorad/ndi/include/cndmorphology.c',
                       'adorad/ndi/include/cndsplines.c',
                       'adorad/ndi/include/cndsupport.c'
                ]
}
...
def write_meta(filename='adorad/_meta.py'):
